<template>
    ...
    <div v-if="propertyData.length === 0" style="text-align: center; margin-top: 20vh; color: #FFA500;">
      <p style="font-size: 80px; width: 60%; margin: 0 auto;">No products available for <br>"{{ searched }}"</p>
