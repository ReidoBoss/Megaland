<template>
  ...
  <div class="bg-auto bg-no-repeat bg-center">
    ...
    <!--OUR VALUES-->
    <div
      class="justify-center flex-1 lg:py-6 md:px-6 custom-sm:w-[100%] custom-sm:mx-auto md:w-[100%]"
    >
      <h1
      ...
      <div
        class="font-poppins flex lg:justify-evenly gap-5 md:gap-10 custom-sm:flex custom-sm:flex-col custom-sm:w-[95%] md:flex-wrap md:flex md:w-[100%] md:justify-center custom-sm:mx-auto"
      >
        <ValCard
          class=""
